...
export const PLATFORM_EVENT_DEFINITIONS: EventDefinition[] = [
  ...
  // ── Royalty Entitlements (Milestone 7.0) ──────────────────────────────
  {
    name: "royalties.entitlement.candidate.created",
    version: V,
    producer: "royalties",
    description: "Entitlement candidate created from approved right",
    contract: contract(V, {
      organizationId: required(f.uuid()),
      candidateId: required(f.string()),
      rightId: required(f.string()),
      revenueCategory: f.string(),
      promotionManifestId: f.string(),
      entitlementId: f.string(),
    }),
    consumers: ["notifications"],
    idempotencyStrategy: "event_subscriber",
    retentionPolicy: "365d",
  ...
  {
    name: "royalties.entitlement.review.completed",
    version: V,
    producer: "royalties",
    description: "Entitlement candidate review completed",
    contract: contract(V, {
      organizationId: required(f.uuid()),
      candidateId: required(f.string()),
      decision: required(f.string()),
  ...
  {
    name: "royalties.entitlement.created",
    version: V,
    producer: "royalties",
    description: "Entitlement registered",
    contract: contract(V, {
      organizationId: required(f.uuid()),
      entitlementId: f.string(),
      rightId: f.string(),
  ...
  {
    name: "royalties.entitlement.updated",
    version: V,
    producer: "royalties",
  ...
  {
    name: "royalties.entitlement.activated",
    version: V,
    producer: "royalties",
    description: "Entitlement activated",
    contract: contract(V, {
      organizationId: required(f.uuid()),
      entitlementId: f.string(),
    }),
  ...
  {
    name: "royalties.entitlement.expired",
    version: V,
    producer: "royalties",
  ...
  {
    name: "royalties.entitlement.transferred",
    version: V,
    producer: "royalties",
    description: "Entitlement ownership transferred",
    contract: contract(V, {
      organizationId: required(f.uuid()),
      entitlementId: f.string(),
    }),
  ...
  {
    name: "royalties.entitlement.suspended",
    version: V,
    producer: "royalties",
  ...
  {
    name: "royalties.entitlement.terminated",
    version: V,
    producer: "royalties",
    description: "Entitlement terminated",
    contract: contract(V, {
      organizationId: required(f.uuid()),
      entitlementId: f.string(),
    }),
