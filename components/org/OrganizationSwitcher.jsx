      ...
      {open && (
        <div className="absolute top-full left-0 mt-2 w-72 bg-surface border border-border rounded-lg shadow-xl overflow-hidden z-[1002]">
          <div className="p-2 border-b border-border">
            <p className="px-2 py-1 text-[10px] font-bold text-text-secondary uppercase tracking-widest">
              Organizations
            </p>
          </div>
          ...
          {showCreate ? (
              ...
              <form onSubmit={handleCreate} className="space-y-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 px-3 py-1.5 bg-accent text-white text-xs font-bold rounded-lg hover:bg-accent/80 disabled:opacity-50 transition-all"
                  >
            ...
            <button
              ...
              className="w-full flex items-center gap-2 px-4 py-2.5 text-sm text-text-secondary hover:text-text-primary hover:bg-white/5 border-t border-border transition-all"
            >
              <Plus size={14} />
              Create Organization
            </button>
