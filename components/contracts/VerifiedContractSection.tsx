 ...
 *
 * This surface intentionally does not expose extraction or verification
 * workflow state. Those actions belong to the Documents tab and verification
 * workspace. The Verified tab only exposes the promoted trusted domain object.
 */
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <h3 className="text-base font-semibold text-white mt-2">
                No verified contract domain object yet.
              </h3>
