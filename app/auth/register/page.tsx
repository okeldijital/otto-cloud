      ...
      <div className="p-8 bg-black/50 backdrop-blur-md rounded-xl border border-white/10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-white/50 mt-2">
            Create your account and organization to get started with OTTO.
          </p>
        </div>
        ...
        {created ? (
          <div className="space-y-4">
            <div className="p-4 rounded-xl border border-white/10 text-sm text-white/70">
              Your account and organization have been created. Check your email to
              verify the account, then sign in to continue.
            </div>
            <Link
              href="/auth/login"
