...
export async function GET(
  ...
  try {
    ...
    const history = await verifiedContractService.getHistory({
    ...
    console.error("[GET verified history]", error);
    return fail("Unable to load verified history", 500, "INTERNAL_ERROR");
  }
}
