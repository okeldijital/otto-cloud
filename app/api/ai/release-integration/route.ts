...
export async function GET(req: Request) {
  try {
    ...
    if (action === "plan") {
      ...
      const run = await prisma.ai_release_integration_runs.findFirst({ where: { id: parseInt(id), organization_id: orgId }, include: { ai_release_integration_links: true } });
