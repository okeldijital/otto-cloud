...
export async function GET(
  ...
  try {
    ...
    const summary = await releaseContractReadModelService.getSummary({
    ...
    console.error("[GET releases/:id/contracts/summary]", error);
    return fail("Unable to load summary", 500, "INTERNAL_ERROR");
  }
}
