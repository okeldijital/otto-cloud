...
type Field = { fieldKey: string; fieldLabel: string; extractedValue: string | null; workingValue: string | null; confidence: number; verificationState: string; };
